---
title: "Rmd_demo_student_version"
author: "Arinze"
date: "8/21/2020"
...
From last semester's TA, Brinnae Bent: "Get comfortable using R Studio and it will make your life a LOT EASIER!" 
...
```{r}
#mean concentration decreases over time.
```
...
ggplot(Indometh, aes(time, conc))+
  geom_jitter(aes(color=Subject))+
  facet_grid(. ~ Subject) #make row of plots, split into columns
```
